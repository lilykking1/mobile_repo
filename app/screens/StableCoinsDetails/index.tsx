...
interface StableCoinsDetailsProps {
  route: {
    params: DashboardRoutes['StableCoinsDetails'];
  };
}

const StableCoinsDetails: FC<StableCoinsDetailsProps> = ({ route }) => {
  ...
  const navBarTitle = (
    <Typography strong size="body1">
      {translate('screens.stableCoinsDetails.title')}
    </Typography>
  );
...
export default StableCoinsDetails;
